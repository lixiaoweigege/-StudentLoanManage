			...
			<div id="aa" class="easyui-accordion" style="width: 100%;"
				data-options="border:0,multiple:true">
					...
					<ul style="list-style-type: none; line-height: 30px; margin-left: -25px">						
						<li><a href="javascript:void(0)" pageUrl="auditing.action">贷款审核</a></li>
							
						<li><a href="javascript:void(0)" pageUrl="allloanrecord.action">贷款合同记录</a></li>
						<li><a href="javascript:void(0)" pageUrl="allStudent.action">学生信息查询</a></li>
						<li><a href="javascript:void(0)" pageUrl="authority.action">权限设置</a></li>
